...
Java course part 14
<ol>
<li>Realizar un programa que escriba distintas líneas con un texto cualquiera (con eñes y acentos)
...
<li>Haz una versión del programa anterior empleando ahora la estructura try-with-resources. Usa
también File.separator para componer la ruta del archivo que se llamará fich02.txt
</li>
<li>Haz una versión del programa anterior, pero en la que se le indique al fichero que está con
codificación ISO-8859-1. Obtiene un fichero llamado fich03.txt
</li>
<li>Basándote en el ejercicio 2 de este capítulo, hay un programa en el usuario introduzca
...
<li>Haz una versión del programa anterior, que compruebe previamente si el fichero fich04.txt
existe o no. En caso afirmativo hará una copia del archivo como fich04.bak y seguirá añadiendo las
líneas sobre fich04.txt .
</li>
<li>Realizar un programa que lea el fichero fich04.txt línea a línea y lo muestre por pantalla, con
el texto en mayúscula. Usar FileReader, try-with-resources y buffers.
</li>
<li> Realizar un programa con un método al que se le pase una cadena con la ruta y nombre de
...
<li> Realizar un programa que escriba distintas líneas de texto en un fichero llamado alumnos.csv,
...
<li> Haz una versión del programa anterior, pero creando un fichero alumnos.txt que, en vez de
